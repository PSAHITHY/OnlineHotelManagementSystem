...
public class GuestServiceTest {
	...
	void testSaveGuest() {
		...
		assertEquals("abc", savedGuest.getGuestName());
	}
	...
	void testInvalidMobile() {
		...
		assertThrows(InvalidMobileNumberException.class, () -> guestService.addGuest(guest));
	}
	...
	void testInvalidEmail() {
		...
		assertThrows(InvalidEmailAddressException.class, () -> guestService.addGuest(guest));
	}
}
